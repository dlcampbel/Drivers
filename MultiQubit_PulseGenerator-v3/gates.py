...
class Gate(Enum):
    ...
    ZX2p = SingleQubitRotation(axis='ZX', angle=np.pi / 2)
    ZX2m = SingleQubitRotation(axis='ZX', angle=-np.pi / 2)
    ZYp = SingleQubitRotation(axis='ZY', angle=np.pi)
    ZYm = SingleQubitRotation(axis='ZY', angle=-np.pi)
    ZY2p = SingleQubitRotation(axis='ZY', angle=np.pi / 2)
    ZY2m = SingleQubitRotation(axis='ZY', angle=-np.pi / 2)
