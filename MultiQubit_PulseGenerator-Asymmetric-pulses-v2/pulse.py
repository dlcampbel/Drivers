...
class Pulse(object):
    ...
    def calculate_waveform(self, t0, t):
        ...
        if self.shape in (PulseShape.COSINE, PulseShape.SQUARE, PulseShape.RAMP, PulseShape.GAUSSIAN, PulseShape.SINSQUARE, PulseShape.SINSQUAREHALF,PulseShape.LZ, PulseShape.BB, PulseShape.BB_Gaussian):
            if self.pulse_type == PulseType.ZXY:
