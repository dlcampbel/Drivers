...
class Crosstalk(object):
    ...
    def set_parameters(self, config={}):
        ...
        if not config.get('Compensate cross-talk'):
            return
        self.scale_CQB1 = config.get('Parameter #9')
        self.scale_CQB2 = config.get('Parameter #10')
        # self.scale_CQB[0:2,2:4] *= config.get('Parameter #9')
        # self.scale_CQB[2:4,0:2] *= config.get('Parameter #9')
        ...
        # self.phi0_vs_voltage = self.phi0_vs_voltage * self.scale_CQB
    ...
    def compensate(self, waveforms):
        ...
        mat_voltage_vs_phi0[0,3] = 0.066 + 0.074+self.scale_CQB1
        mat_voltage_vs_phi0[1,2] = 0.066 - 0.074-self.scale_CQB1
        mat_voltage_vs_phi0[2,1] = -0.03 +0.03 - 0.009 + 0.0025 - self.scale_CQB2
        mat_voltage_vs_phi0[3,0] = -0.03 -0.03 + 0.009 - 0.0025 + self.scale_CQB2#-0.03
        # mat_voltage_vs_phi0 *= -self.scale_CQB
