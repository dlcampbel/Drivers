...
class Gate(Enum):
    ...
    # period = 14.03538e-9 # valid at 4.19 GHz
    period = 14.24038e-9 # valid at 4.13 GHz

    Z00 = IdentityGate(width = period)
    Zp = IdentityGate(width = 0.5*period)
    Z2p = IdentityGate(width = 0.75*period)
    Zm = IdentityGate(width = 0.5*period)
    Z2m = IdentityGate(width = 0.25*period)
